 ...
 * and y, calculate the Hamming distance. Note: 0 ≤ x, y < 231. Example: Input:
 * x = 1, y = 4 Output: 2
 * 
 * Explanation: 
 * 1 (0 0 0 1) 
...
public class HammingDistance {
   ...
   public static void main(String[] args) {
      System.out.println(String.format("Hamming distance between %s and %s is %s", 1, 4, hammingDistance(1, 4)));
   }
}
